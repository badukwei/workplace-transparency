export default function Focus() {
  return (
    <div className="p-8 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 flex justify-between bg-white rounded shadow-lg">
      <div className="flex flex-col gap-8 mr-8">
        <div>
          <h1 className="text-marineBlue text-4xl font-medium mt-2 mb-2">
            WorkTrans
          </h1>
          <p className="text-marineBlue text-lg font-normal">
            Bringing clarity to the workplace
          </p>
        </div>
        <div className="flex flex-col gap-4">
          <div className="p-2 flex justify-center bg-magnolia rounded">
            <p className="text-m text-marineBlue font-medium">
              Search For Jobs
            </p>
          </div>
          <div className="p-2 flex justify-center bg-purplishBlue rounded">
            <p className="text-m text-magnolia font-medium">
              Share Your Experience
            </p>
          </div>
        </div>
        <div className="mb-auto">
          <p className="text-marineBlue text-lg font-normal">Join us in improving the work experience. Share your insights and help shape our site.</p>
        </div>
        <div className="self-center">
          <p className="text-marineBlue text-s font-light">contact us: badukwei8611@gmail.com</p>
        </div>
      </div>
      <div>
        <svg
